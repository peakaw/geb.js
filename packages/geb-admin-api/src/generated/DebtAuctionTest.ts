...
export class DebtAuctionTest extends BaseContractAPI {
    ...
    test_debt_auction(ethValue: BigNumberish): TransactionRequest {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"test_debt_auction","outputs":[],"stateMutability":"payable","type":"function"}
