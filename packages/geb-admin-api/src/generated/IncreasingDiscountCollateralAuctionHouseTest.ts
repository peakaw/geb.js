...
export class IncreasingDiscountCollateralAuctionHouseTest extends BaseContractAPI {
    ...
    test_collateral_auction(ethValue: BigNumberish): TransactionRequest {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"test_collateral_auction","outputs":[],"stateMutability":"payable","type":"function"}
