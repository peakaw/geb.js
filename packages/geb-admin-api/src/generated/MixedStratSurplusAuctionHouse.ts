...
export class MixedStratSurplusAuctionHouse extends BaseContractAPI {
    ...
    FIFTY(): Promise<BigNumber>
    FIFTY(multicall: true): MulticallRequest<BigNumber>
    FIFTY(multicall?: true): Promise<BigNumber> | MulticallRequest<BigNumber> {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"FIFTY","outputs":[{"internalType":"uint256","name":"","type":"uint256"}],"stateMutability":"view","type":"function"}
