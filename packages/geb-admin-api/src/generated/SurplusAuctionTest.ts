...
export class SurplusAuctionTest extends BaseContractAPI {
    ...
    test_surplus_auction(ethValue: BigNumberish): TransactionRequest {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"test_surplus_auction","outputs":[],"stateMutability":"payable","type":"function"}
