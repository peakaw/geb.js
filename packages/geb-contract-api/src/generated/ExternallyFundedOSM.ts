...
export class ExternallyFundedOsm extends BaseContractAPI {
    ...
    fsmWrapper(): Promise<string>
    fsmWrapper(multicall: true): MulticallRequest<string>
    fsmWrapper(multicall?: true): Promise<string> | MulticallRequest<string> {
        // prettier-ignore
        // @ts-ignore
        const abi = {"inputs":[],"name":"fsmWrapper","outputs":[{"internalType":"contract FSMWrapperLike","name":"","type":"address"}],"stateMutability":"view","type":"function"}
    ...
    modifyParameters(parameter: BytesLike, val: string): TransactionRequest {
        // prettier-ignore
        // @ts-ignore
